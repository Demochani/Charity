  ...
  return (
    <div className="help-title-container">
      <div className="help-title">
        ...
        <h3>
          Conducting modern defensive tactics and repelling attacks of the
          aggressor requires the provision of soldiers of the Armed Forces of
          Ukraine with innovative equipment for the rapid detection of invaders,
          which in turn will save the life of a Ukrainian soldier. These are
          expensive devices, thermal imagers, collimator sights, night vision
          devices, vehicles for transporting the wounded and much more.
          Ukrainians will never forget the generosity and support of the
